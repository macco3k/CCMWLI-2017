...
class Brain:
    ...
    def __init__(self, filename, order=3):
    ...
    def learnfile(self, files):
        self.start_batch_learning()
        ...
        for filename in files:
            ...
            count = 0
            for line, progress in self.progress_generator(filename):
                ...
                if show_progress:
                    ...
                    print("\r%.0f%% (%d/s)" % (progress, count / elapsed))

                self.learn(line.strip())
                count = count + 1
        ...
        self.stop_batch_learning()

    def progress_generator(self, filename):
        s = os.stat(filename)
        size_left = s.st_size
